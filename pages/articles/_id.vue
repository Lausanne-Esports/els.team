  ...
  head () {
    return {
      ...
      meta: [
        ...
        { hid: 'twitter:card', name: 'twitter:card', content: this.article.featured_thumbnail },
        { hid: 'twitter:site', name: 'twitter:site', content: '@lausanneesports' },
        { hid: 'twitter:description', name: 'twitter:description', content: this.article.description },
        { hid: 'twitter:image', name: 'twitter:image', content: this.article.featured_thumbnail },
      ],
    }
  },
