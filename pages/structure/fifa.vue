<template>
  <section class="page">
    <header class="d-flex align-items-end">
      ...
      <div class="container">
        <h1>{{ lineup.game }}</h1>
        <p class="sub-title">{{ lineup.name }}</p>
      </div>
    </header>
    <div class="container body">
      <div class="row">
        <div class="col-md-4" v-for="(player, index) in players" :key="index">
  ...
  data () {
    return {
      ...
      players: [{
        ...
        lastname: 'Tornese',
        role: 'Joueur',
        picture: '/images/players/default.png',
        socials: [
          {
            type: 'twitter',
            url: 'http://twitter.com/dodo021'
          },
          {
            type: 'facebook',
            url: '#'
